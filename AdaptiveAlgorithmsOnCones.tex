...
\DeclareMathOperator{\vdist}{\mathbf{dist}}
\DeclareMathOperator{\datacrit}{STOP}
\newcommand{\true}{\textup{TRUE}}
\newcommand{\false}{\textup{FALSE}}
\newcommand{\err}{\textup{ERR}}
\newcommand{\lo}{\textup{lo}}
\newcommand{\high}{\textup{hi}}
...
\mainmatter
\input{Part_1/IllustratingKey}
\input{Part_1/WhyAdaptiveAlgorithms}
\input{Part_1/SingleZeroUnivariate}
\input{Part_1/AllZerosUnivariate}
\input{Part_1/RelativeError}
\input{Part_1/NoSolution}
